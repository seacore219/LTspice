...
![gui](figures/gui_preview.png)

Four stacked panels — pulser gate currents, transponder input-gate currents,
**loop currents (the EPSPs)**, and output voltages — with live sliders for the
detector Δt and all eight bias voltages.
